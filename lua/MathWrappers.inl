...
// 		}
		...
		template <typename T>
		mye::core::String __quat_tostring(const mye::math::QuaternionTempl<T> &q)
		{
		...
		T __quat_get(const mye::math::QuaternionTempl<T> &q)
		{
			return q[I];
		}

		template <typename T, int I>
		void __quat_set(mye::math::QuaternionTempl<T> &q, T b)
		{
			q[I] = b;
		}
