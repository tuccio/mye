...
namespace mye
{
	...
	namespace lua
	{
		...
		template <typename T>
		inline mye::core::String __quat_tostring(const mye::math::QuaternionTempl<T> &q);

		template <typename T, int I>
		inline T __quat_get(const mye::math::QuaternionTempl<T> &q);

		template <typename T, int I>
		inline void __quat_set(mye::math::QuaternionTempl<T> &q, T b);
